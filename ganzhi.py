...
zhichang = {
    "子":OrderedDict({"癸":100}),
    "丑":OrderedDict({"辛":10,"癸":20, "己":70}),
    "寅":OrderedDict({"戊":10,"丙":20, "甲":70}),
    "卯":OrderedDict({"乙":100}),
    "辰":OrderedDict({"癸":10,"乙":20, "戊":70}),
    "巳":OrderedDict({"庚":20,"戊":10, "丙":70}),
    "午":OrderedDict({"己":30, "丁":70}),
    "未":OrderedDict({"乙":10,"丁":20, "己":70}),
    "申":OrderedDict({"戊":10,"壬":20, "庚":70}),
    "酉":OrderedDict({"辛":100}),
    "戌":OrderedDict({"丁":10,"辛":20, "戊":70}),
    "亥":OrderedDict({"甲":30, "壬":70})}
